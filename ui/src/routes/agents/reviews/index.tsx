    ...
    <main className="min-w-0 flex-1 overflow-y-auto">
      <div className="mx-auto max-w-3xl px-6 py-8">
        ...
        <p className="mt-1 text-xs text-[var(--ui-text-muted)]">
          Pull requests reviewed by loupfeed agents Review. Click into one for the full
          analysis.
        </p>
          ...
          {reviews.data && items.length === 0 && (
            <p className="px-4 py-3 text-xs text-[var(--ui-text-muted)]">
              {mine
                ...
                : "No reviews yet. Enable repositories under loupfeed agents Review settings and open a PR."}
            </p>
          )}
