...
│◠│
╰─╯`}</pre>
        <span className="text-gray-300 font-medium">loupfeed agents Desktop App</span>
      </div>
    );
  }
...
{` ╭───╮
 ...
 ╰───╯`}
      ...
      <span className="text-gray-200 font-semibold">loupfeed agents Desktop App v0.1.0</span>
    </div>
  );
}
