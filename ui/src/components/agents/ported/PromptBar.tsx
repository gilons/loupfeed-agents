  ...
  if (toolKind === 'execute') {
    ...
    return {
      ...
      options: [
        ...
        { label: 'No, and tell loupfeed agents what to do differently', decision: 'reject' },
      ],
    };
  }
        ...
        {hasPendingApproval && approvalContent ? (
          ...
          <>
            <textarea
              ...
              placeholder={busy ? "Send a message to queue next..." : "Ask loupfeed agents anything, @ to add files, / for commands"}
